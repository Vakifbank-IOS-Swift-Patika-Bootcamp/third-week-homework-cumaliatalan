...
class Client {
    ...
    enum Endpoints {
        static let base = "https://programming-quotes-api.herokuapp.com" // https://wizard-world-api.herokuapp.com
    ...
    class func getQuotes(completion: @escaping ([QuotesModel]?, Error?) -> Void) {
        taskForGETRequest(url: Endpoints.quotes.url, responsetType: [QuotesModel].self) { response, error in
